//+------------------------------------------------------------------+
//| LOTSIZE-OPTIMIERUNG PATCH v9.0 - NUR DIESE FUNKTIONEN HINZUFÜGEN |
//| Fügen Sie diese 5 Funktionen in Ihren ursprünglichen v8.x Code ein |
//+------------------------------------------------------------------+

// ⚠️ WICHTIGE ANWEISUNGEN:
// 1. Kopieren Sie diese 5 Funktionen in Ihren ursprünglichen v8.x Code
// 2. Fügen Sie sie NACH den Log-Funktionen ein (nach LogDebug, LogError, etc.)
// 3. Ersetzen Sie in ProcessSignal() den Aufruf der alten Lotsize-Berechnung
// 4. Ändern Sie die Version von "8.60" auf "9.0" im #property version
...
//+------------------------------------------------------------------+
//| ENDE DER v9.0 PATCH-FUNKTIONEN                                  |
//+------------------------------------------------------------------+

// ⚠️ INTEGRATION-ANWEISUNGEN:
// 
// 1. KOPIEREN Sie diese 5 Funktionen in Ihren ursprünglichen v8.x Code
//    Fügen Sie sie NACH den Log-Funktionen ein (LogDebug, LogError, etc.)
//
// 2. SUCHEN Sie in ProcessSignal() nach der Lotsize-Berechnung:
...
//
// 4. ÄNDERN Sie die Version:
//    #property version   "9.0"
//
// 5. KOMPILIEREN und testen Sie den EA
//
// Das war's! Alle anderen Funktionen bleiben unverändert.
// Das JPY-Problem ist damit behoben, ohne andere Funktionalitäten zu beeinträchtigen.
