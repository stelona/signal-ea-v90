...
#
# Workflow:
# 1. Temp-MT5 starten und einloggen
...
# ═══════════════════════════════════════════════════════════════════════════
# Config & Login (from auto_login.py)
# ═══════════════════════════════════════════════════════════════════════════
...
def find_servers_dat() -> Optional[str]:
    ...
    # Wine paths
    if 'wine' in data_path.lower() or '.wine' in data_path.lower():
        wine_home = os.path.expanduser("~/.wine")
        wine_search = os.path.join(wine_home, "drive_c", "users", "*", "AppData", "Roaming", "MetaQuotes", "Terminal", "*", "config", "servers.dat")
        search_paths.extend(glob.glob(wine_search))
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='MT5 Pre-Flight Check: Symbol-Erkennung + Server-Config Upload'
    )
    ...
    logging.info("═══════════════════════════════════════════════════════════")
    logging.info("")
    print_success("Ihr System kann jetzt Customer-MT5 mit korrektem Template starten!")
