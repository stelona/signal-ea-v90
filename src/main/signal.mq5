...
void SendLogoutStatus(int deInitReason)
{
    ...
    int res = WebRequest("POST", InpAPILoginUrl, headers, 5000, post, result, resultHeaders);
...
int OnInit()
{
    ...
    Print("====================================");
    Print("Signal Receiver EA v9 OPTIMIZED");
    Print("====================================");
...
void CheckPositionStatus(int posIndex)
{
    ...
    int res = WebRequest("GET", fullUrl, headers, timeout, post, result, resultHeaders);
